  ...
  - 🌈 [Raytracer in C#](https://github.com/MuellerMarvin/RayTracer-in-CSharp) - Custom 3D renderer
   built from scratch
  - 🦜 CHIRP - IoT biodiversity tracker using bird-sound species identification
  - 📞 CallAI - Fullstack platform for creating interactive customer service call bots
  - 🚴 CitiBike Data Analysis - 32GB of historical ride data
